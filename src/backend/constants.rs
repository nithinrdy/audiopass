...
pub const AUDIOPASS_VIRTUAL_SINK_STREAM_NAME: &str = "AudioPass Virtual Sink Stream";

pub const AUDIOPASS_VIRTUAL_MIC_CHANNEL_COUNT: u8 = 2;
pub const AUDIOPASS_VIRTUAL_MIC_SAMPLE_RATE: u16 = 48000;

pub const AUDIOPASS_AUDIO_FRAME_SIZE_BYTES: usize = AUDIOPASS_VIRTUAL_MIC_CHANNEL_COUNT as usize * size_of::<f32>();
pub const AUDIOPASS_MIC_RING_CAPACITY_BYTES: usize = (AUDIOPASS_VIRTUAL_MIC_SAMPLE_RATE / 10) as usize // 100ms worth of samples
  * AUDIOPASS_AUDIO_FRAME_SIZE_BYTES; // so 100ms worth of bytes
