...
- any connected physical microphone,
- any locally running application playing audio
- _[work-in-progress]_ any local audio files

AudioPass is licensed under the MIT license.

## Minimum Requirements

AudioPass has the following minimum requierments:
...
Notably for Ubuntu users, AudioPass will NOT run on Ubuntu 22.04 LTS. I'm looking into lowering this minimum requirement to allow the app to run on older distros like Ubuntu 22.04, but it's not a priority for me right now.
